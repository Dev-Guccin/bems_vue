...
var Database = {
  ...
  realtime_upsert: function (id, object_name, address, resData, object_type) {
    connection.query(
      `insert into realtime_table (id, object_name, address, log_value, log_time ,object_type, network_type )
        values (${id},'${object_name}',${address}, ${resData}, now(),'${object_type}','modbus') as t
