<template>
  <div>
    <b-navbar type="dark" class="px-3 navbar">
      <b-navbar-brand href="#">
        4MSYS BEMS
      </b-navbar-brand>
      <b-spinner variant="success" class="spinner"></b-spinner>
    </b-navbar>
    <b-container fluid class="m-0 p-0 sidebar">
      <b-row>
        <b-col cols="2" class="p-0 ">
          <b-nav vertical class="vh-100 ">
            <v-list color="transparent p-0 ">
              ...
              >
                <v-list-item link router :to="{ name: item.router }">
                  <v-list-item-icon>
              ...
              <v-list-item link router :to="{ name: setting[0].router }">
                <v-list-item-icon>
...
export default {
  ...
  data() {
    return {
      drop: true,
      links: [{ text: "Dashboard", router: "Home" }],
      side: [
        {
          text: "종합보기",
          router: "Home",
      ...
      setting: [{ text: "환경설정", router: "Admin", icon: "mdi-cog-outline" }],
    };
  },
};
</script>
